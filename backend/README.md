...
## Project Structure
    ...
    ├── dynastyhealth_heali_32478  # Django project configurations
...
1. Clone this repo and `cd dynastyhealth_heali_32478`
...
2. Clone this repo and `cd dynastyhealth_heali_32478`
